...
\venue{}
\date{}
\author{Langston Hughes, David Brubeck}
...
\begin{frame}[bg=lausanne-tl-public-transport-map-faded.png]
...
\begin{frame}
\frametitle{Test logo}

\includegraphics[width=.8\textwidth]{EPFL_Logo_184X53.eps}
